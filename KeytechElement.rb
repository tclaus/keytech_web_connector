...
class KeytechElement
	...
	attr_accessor :elementDescription, :elementDisplayName, :elementKey, :elementName, :elementStatus, :elementTypeDisplayName, :elementVersion, :hasVersions, :thumbnailHint, :elementReleasedAt, :elementReleasedBy, :elementReleasedByLong
